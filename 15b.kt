...
fun main() {
    ...
    outer@ for (elfAttack in 4..200) {
        ...
        val elves = c.count(Creature::isElf)
            ...
            for (i in 0 until n) {
                for (j in 0 until m) {
                    ...
                    if (targets.isEmpty()) {
                        ...
                        val survived = a.sumBy { row ->
                            row.sumBy { w ->
                                if (w >= 1 && c[w].isElf) 1 else 0
                            }
                        }
                        if (survived == elves) {
                            println(elfAttack)
                    ...
                    c[a[attack]!!].health -= if (c[id].isElf) elfAttack else 3
