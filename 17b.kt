...
fun main() {
    ...
    val was = a.indices.sumBy { i -> if (i in min..max) a[i].indices.sumBy { j -> if (a[i][j] == 1 && a[i][j] != b[i][j]) 1 else 0 } else 0 }
    ...
    val now = a.indices.sumBy { i -> if (i in min..max) a[i].indices.sumBy { j -> if (a[i][j] == 1 && a[i][j] != b[i][j]) 1 else 0 } else 0 }
    println(now - was)
}
